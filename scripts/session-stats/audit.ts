 ...
 * asks a small model (default: anthropic/claude-sonnet-4-6 via @aryee337/aery-ai)
 * to judge:
 ...
 *   bun scripts/session-stats/audit.ts --folder Projects-aery --max-llm 6
 *   bun scripts/session-stats/audit.ts --json out.json
 *
 * Auth: resolves an API key for the classifier provider through aery's auth
...
/** Narrow view of aery-ai's AssistantMessage used here (content + usage). */

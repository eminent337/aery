...
# AERY Coding Agent Installer
# Usage: curl -fsSL https://raw.githubusercontent.com/eminent337/aery/main/scripts/install.sh | sh
#
# Options:
...
REPO="eminent337/aery"
PACKAGE="@aryee337/aery-coding-agent"
...
install_via_bun() {
    ...
    echo ""
    echo "✓ Installed aery via bun"
    echo "Run 'aery' to get started!"
}
...
install_binary() {
    ...
    curl -fsSL "$BINARY_URL" -o "${INSTALL_DIR}/aery"
    chmod +x "${INSTALL_DIR}/aery"
    echo ""
    echo "✓ Installed aery to ${INSTALL_DIR}/aery"

    # Check if in PATH
    case ":$PATH:" in
        *":$INSTALL_DIR:"*) echo "Run 'aery' to get started!" ;;
        *) echo "Add ${INSTALL_DIR} to your PATH, then run 'aery'" ;;
    esac
}

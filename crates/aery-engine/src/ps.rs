...
//!
//! The platform-specific implementation lives in [`aery_shell::process`]; this
...
use aery_shell::process::{self as core_process, ProcessStatus as CoreProcessStatus};
pub use aery_shell::process::{KILL_SIGNAL, TERM_SIGNAL, TerminationTargets, kill_process_group};
use napi::{
	Env, Result,

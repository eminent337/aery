...
impl From<aery_ast::block::BlockRange> for BlockRange {
	fn from(value: aery_ast::block::BlockRange) -> Self {
...
pub fn block_range_at(options: BlockRangeOptions) -> Result<Option<BlockRange>> {
	aery_ast::block::block_range_at(aery_ast::block::BlockRangeOptions {
		code: options.code,
		lang: options.lang,
		path: options.path,
		line: options.line,

...
impl From<aery_ast::summary::SummarySegment> for SummarySegment {
	fn from(value: aery_ast::summary::SummarySegment) -> Self {
		Self {
			kind:       value.kind,
...
impl From<aery_ast::summary::SummaryResult> for SummaryResult {
	fn from(value: aery_ast::summary::SummaryResult) -> Self {
		Self {
...
pub fn summarize_code(options: SummaryOptions) -> Result<SummaryResult> {
	aery_ast::summary::summarize_code(aery_ast::summary::SummaryOptions {
		code:               options.code,
		lang:               options.lang,
		path:               options.path,

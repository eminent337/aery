//! Native utilities exported via N-API for the Aery toolchain.
//!
//! # Overview
...
//! # Example
//! ```ignore
//! use aery_engine::text::visible_width;
//!
...
//! # Architecture
//! ```text
//! JS (packages/aery-engine) -> N-API -> Rust modules (clipboard/fd/glob/grep/html/highlight/sixel/text)
//! ```
...
///
/// Bump policy: `__aeryNativesV{major}_{minor}_{patch}` — non-alphanumerics in
...
#[napi(js_name = "__aeryNativesV0_1_10")]

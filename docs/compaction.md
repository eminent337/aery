...
- Includes prior compaction details only when prior entry is aery-generated (`fromExtension !== true`).
...
1. First pass: collect cumulative file ops from all summarized entries, including prior aery-generated `branch_summary` details.

...
- syntax highlighting colors used by native highlighter (`@aryee337/aery-engine`)
...
- default agent dir: `~/.aery/agent`
- effective default file: `~/.aery/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.aery/agent/themes/my-theme.json`.

...
- Isolation merge strategy
  ...
  - Branch mode — commit each task onto `aery/task/<id>` branch, cherry-pick into parent, preserve failed branches for manual resolution.
- Agent source
...
- Subprocesses / native bindings
  ...
  - ProjFS native bindings via `@aryee337/aery-engine` on Windows.

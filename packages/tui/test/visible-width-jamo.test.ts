...
import { Ellipsis, sliceWithWidth, truncateToWidth, visibleWidth } from "@aryee337/aery-tui/utils";
...
describe("native text helpers — Hangul Compatibility Jamo correction", () => {
	...
	// crates/aery-engine/src/text.rs. They will fail until the native

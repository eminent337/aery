...
import { shouldTrustNativeViewportProbe } from "@aryee337/aery-tui/terminal";
import { VirtualTerminal } from "./virtual-terminal";

// Regression test for https://github.com/eminent337/aery/issues/1635
//
// Native Windows + Windows Terminal (ConPTY) routes `aery` through a

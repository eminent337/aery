...
async function generateModels() {
	...
	const googleGeminiCliModels: Model<"google-gemini-cli">[] = [
		{
			id: "gemini-2.0-flash",
	...
	const googleAntigravityModels: Model<"google-gemini-cli">[] = [
		{
	...
	allModels.push(...googleGeminiCliModels, ...googleAntigravityModels, ...vertexModels);

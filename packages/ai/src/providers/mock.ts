 ...
 * aery-agent-core / streamSimple-shaped consumers without an HTTP client.
 *
 * Usage:
 *
 *   import { createMockModel, registerMockApi } from "@aryee337/aery-ai/providers/mock";
 *
...
export class MockModel implements Model<MockApi> {
	...
	/** A streamFn-compatible callable. Forward to `agentLoop` or aery `stream()`. */
...
/** Stream function for `Model<"mock">`. Matches the aery-ai per-provider stream signature. */
...
export function registerMockApi(sourceId = "aery-ai/mock"): void {

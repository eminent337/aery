...
import { convertAnthropicMessages } from "@aryee337/aery-ai/providers/anthropic";
import { transformMessages } from "@aryee337/aery-ai/providers/transform-messages";
import type { AssistantMessage, Message, Model, UserMessage } from "@aryee337/aery-ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.aery/logs/http-400-requests/*.json` after Claude

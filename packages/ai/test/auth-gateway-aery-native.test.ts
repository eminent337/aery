...
import { encodeStream, formatError, parseRequest } from "../src/providers/aery-native-server";
import type {
	AssistantMessage,
...
describe("aery-native parseRequest", () => {
...
describe("aery-native encodeStream", () => {
	it("ships every AssistantMessageEvent verbatim, terminated by [DONE]", async () => {
		// Aery-native is aery-talks-to-aery: the client feeds parsed events directly
...
describe("aery-native formatError", () => {

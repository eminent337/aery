...
import type { AssistantMessage, Model, ToolResultMessage, UserMessage } from "@aryee337/aery-ai/types";
 ...
 * carries `tool_use_id`. As a workaround, AERY must include `id` (aliased to

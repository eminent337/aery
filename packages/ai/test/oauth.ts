/**
 * Test helper for resolving API keys from ~/.aery/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@aryee337/aery-ai/utils/oauth";
import type { OAuthCredentials, OAuthProvider } from "@aryee337/aery-ai/utils/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@aryee337/aery-utils";
...
/**
 * Resolve API key for a provider from ~/.aery/agent/testauth.db
 *

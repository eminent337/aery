...
import type { Api, Context, Model, Tool, ToolResultMessage } from "@aryee337/aery-ai";
import { complete, getBundledModel } from "@aryee337/aery-ai";
import type { OptionsForApi } from "@aryee337/aery-ai/types";
...
describe("Tool Results with Images", () => {
	...
	describe("Google Antigravity Provider", () => {
		...
		/** These two don't work, the model simply won't call the tool, works in aery
		it.skipIf(!antigravityToken)(

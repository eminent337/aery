...
import { complete } from "@aryee337/aery-ai/stream";
import type { Api, Context, Model, OptionsForApi, ToolResultMessage } from "@aryee337/aery-ai/types";
...
- Thinking face: 🤔
- Rocket: 🚀
- Mixed text: Test User wann? Wo? Bin grad äußersr eventuninformiert 🙈
- Japanese: こんにちは
- Chinese: 你好
...
=> {
  "comments": [
    ...
    {
      "author": "Matthias Neumayer's  graphic link",
      "text": "Test User wann? Wo? Bin grad äußersr eventuninformiert 🙈"
    }
  ]
}`,
			},

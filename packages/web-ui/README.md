...
```bash
npm install @eminent337/aery-web-ui @eminent337/aery-core @eminent337/aery-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@eminent337/aery-web-ui';
import '@eminent337/aery-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@eminent337/aery-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@eminent337/aery-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@eminent337/aery-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@eminent337/aery-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@eminent337/aery-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@eminent337/aery-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@eminent337/aery-web-ui';
...
```typescript
import { SessionListDialog } from '@eminent337/aery-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@eminent337/aery-web-ui';
...
```typescript
import { ModelSelector } from '@eminent337/aery-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@eminent337/aery-web-ui';

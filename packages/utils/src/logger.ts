/**
 * Centralized logger for aery.
 *
 * Default: rotating `~/.aery/logs/aery.<DATE>.log`, no console output (writing
 ...
 *
 * Each entry includes `process.pid` so concurrent aery instances stay
 * traceable.
 */

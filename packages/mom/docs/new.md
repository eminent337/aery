...
```typescript
import { type AgentSessionEvent } from "@eminent337/aery";
...
import type { MomCustomTool, ToolAPI } from "@eminent337/aery-mom";
...
Tools are loaded via jiti. They can import any 3rd party dependencies (install in the tool directory). Imports of `@eminent337/aery-ai` and `@eminent337/aery-mom` are aliased to the running mom bundle.

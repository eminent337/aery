...
const candidates: CandidateAddon[] =
	targetArch === "x64"
		? [
				{ variant: "modern", filename: `aery_engine.${platformTag}-modern.node` },
				{ variant: "baseline", filename: `aery_engine.${platformTag}-baseline.node` },
			]
		: [{ variant: "default", filename: `aery_engine.${platformTag}.node` }];

 ...
 * (https://opentelemetry.io/docs/specs/semconv/gen-ai/) plus `aery.gen_ai.*`
...
export const DEFAULT_TRACER_NAME = "@aryee337/aery-core";
...
export const enum PiGenAIAttr {
	AgentStepNumber = "aery.gen_ai.agent.step.number",
	AgentStepCount = "aery.gen_ai.agent.step.count",
	RequestReasoningEffort = "aery.gen_ai.request.reasoning.effort",
	RequestToolChoice = "aery.gen_ai.request.tool.choice",
	RequestAvailableTools = "aery.gen_ai.request.available_tools",
	RequestMessages = "aery.gen_ai.request.messages",
	ResponseText = "aery.gen_ai.response.text",
	ResponseToolCalls = "aery.gen_ai.response.tool_calls",
	UsageTotalTokens = "aery.gen_ai.usage.total_tokens",
	UsageServerSideTools = "aery.gen_ai.usage.server_tool_requests",
	CostEstimatedUsd = "aery.gen_ai.cost.estimated_usd",
	CostInputUsd = "aery.gen_ai.cost.input_usd",
	CostOutputUsd = "aery.gen_ai.cost.output_usd",
	CostUnavailableReason = "aery.gen_ai.cost.unavailable_reason",
	ToolStatus = "aery.gen_ai.tool.status",
	ToolCallIntent = "aery.gen_ai.tool.call.intent",
	HandoffFromAgentName = "aery.gen_ai.handoff.from_agent.name",
	HandoffFromAgentId = "aery.gen_ai.handoff.from_agent.id",
	HandoffToAgentName = "aery.gen_ai.handoff.to_agent.name",
	HandoffToAgentId = "aery.gen_ai.handoff.to_agent.id",
	...
	OneshotKind = "aery.gen_ai.oneshot.kind",
	...
	GatewayName = "aery.gen_ai.gateway.name",
	GatewayEndpoint = "aery.gen_ai.gateway.endpoint",
	GatewayCallId = "aery.gen_ai.gateway.call_id",
	GatewayRoutedTo = "aery.gen_ai.gateway.routed_to",
}
 ...
 *   { usd: number }                — cost is known; emitted as aery.gen_ai.cost.estimated_usd
 *   { unavailable: string }        — cost is intentionally unknown; emitted as
 *                                    aery.gen_ai.cost.unavailable_reason
...
export interface ChatUsageEvent {
	 ...
	 * auto-stamped on the chat span as `aery.gen_ai.gateway.*` attributes.
	 */
...
function emitTelemetryWarning(telemetry: AgentTelemetry | undefined, warning: AgentTelemetryWarning): void {
	...
	if (!hook) {
		if (warning.error === undefined) console.warn(`[aery-agent] ${warning.message}`);
		else console.warn(`[aery-agent] ${warning.message}`, warning.error);
		return;
	}
	try {
		hook(warning);
	} catch (err) {
		console.warn("[aery-agent] onTelemetryWarning threw; swallowing:", err);
	}
}
...
export interface InstrumentedChatSpanOptions {
	...
	readonly stepNumber?: number;
	/**
	 * Tag stamped onto `aery.gen_ai.oneshot.kind`. Values used by the agent:
	 ...
	 * `completeSimple` from `@aryee337/aery-ai`. Use to retain a test injection
...
/** Aggregate `aery.gen_ai.agent.*` attributes stamped on the `invoke_agent` span. */
export const enum PiGenAIAggregateAttr {
	ChatsCount = "aery.gen_ai.agent.chats.count",
	ChatsTotalLatencyMs = "aery.gen_ai.agent.chats.total_latency_ms",
	ChatsStopReasonPrefix = "aery.gen_ai.agent.chats.stop_reason.",
	ToolsCount = "aery.gen_ai.agent.tools.count",
	ToolsOkCount = "aery.gen_ai.agent.tools.ok.count",
	ToolsErrorCount = "aery.gen_ai.agent.tools.error.count",
	ToolsSkippedCount = "aery.gen_ai.agent.tools.skipped.count",
	ToolsBlockedCount = "aery.gen_ai.agent.tools.blocked.count",
	ToolsTimeoutCount = "aery.gen_ai.agent.tools.timeout.count",
	ToolsAbortedCount = "aery.gen_ai.agent.tools.aborted.count",
	ToolsTotalLatencyMs = "aery.gen_ai.agent.tools.total_latency_ms",
	ToolsInvoked = "aery.gen_ai.agent.tools.invoked",
	ToolsAvailable = "aery.gen_ai.agent.tools.available",
	ToolsUnused = "aery.gen_ai.agent.tools.unused",
	UsageInputTokensTotal = "aery.gen_ai.agent.usage.input_tokens.total",
	UsageOutputTokensTotal = "aery.gen_ai.agent.usage.output_tokens.total",
	UsageCacheReadInputTokensTotal = "aery.gen_ai.agent.usage.cache_read.input_tokens.total",
	UsageCacheCreationInputTokensTotal = "aery.gen_ai.agent.usage.cache_creation.input_tokens.total",
	UsageReasoningOutputTokensTotal = "aery.gen_ai.agent.usage.reasoning.output_tokens.total",
	UsageTotalTokensTotal = "aery.gen_ai.agent.usage.total_tokens.total",
	CostEstimatedUsdTotal = "aery.gen_ai.agent.cost.estimated_usd.total",
	ErrorsCount = "aery.gen_ai.agent.errors.count",
}

/** Stamp the aggregate `aery.gen_ai.agent.*` attributes on the given span. */

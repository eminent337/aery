...
export interface GenerateBranchSummaryOptions {
	 ...
	 * wrapped in an OTEL chat span tagged with `aery.gen_ai.oneshot.kind = "branch_summary"`.
	 */
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from aery-generated summaries (fromExtension !== true), not extension-generated ones

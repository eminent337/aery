...
describe("resource expansion helpers", () => {
	it("expands skills with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.aery/skills/inspect/SKILL.md",
		};

		expect(expandSkillCommand(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.aery/skills/inspect/SKILL.md">\nReferences are relative to /project/.aery/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});

...
import { formatDuration, formatNumber, formatPercent } from "@aryee337/aery-utils";
...
async function main(): Promise<void> {
	...
	if (values.help) {
		console.log(`
aery-stats - AI Usage Statistics Dashboard
...
Examples:
  aery-stats              # Start dashboard server
  aery-stats --json       # Print stats as JSON
  aery-stats --port 8080  # Start on custom port
  aery-stats --sync       # Sync and show summary
`);
		return;
	}

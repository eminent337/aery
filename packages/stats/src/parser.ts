...
import { type AssistantMessage, getPriorityPremiumRequests, type ServiceTier } from "@aryee337/aery-ai";
import { getSessionsDir, isEnoent } from "@aryee337/aery-utils";
import type {
	MessageStats,
	SessionEntry,
	SessionMessageEntry,
 ...
 * Session files are named like: --work--aery--/timestamp_uuid.jsonl
...
function extractFolderFromPath(sessionPath: string): string {
	...
	// Convert --work--aery-- to /work/aery

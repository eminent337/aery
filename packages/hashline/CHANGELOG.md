...
- Fixed hashline replacements that accidentally restated unchanged lines above and below the selected range so they no longer duplicate both boundary lines ([#1664](https://github.com/eminent337/aery/issues/1664)).
...
- Initial standalone release. Extracted from `@aryee337/aery`.

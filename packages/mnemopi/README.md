# @aryee337/aery-mnemopi

Local SQLite memory engine for Aery agents.
...
```ts
import { Mnemopi } from "@aryee337/aery-mnemopi";
...
The Aery coding-agent wrapper adds `mnemopi.scoping` on top of those constructor options:

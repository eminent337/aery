 ...
 *
 * Usage:
 *   aery --hook examples/hooks/custom-compaction.ts
 */

import type { HookAPI } from "@aryee337/aery";
import { convertToLlm, serializeConversation } from "@aryee337/aery";
import { complete, getModel } from "@aryee337/aery-ai";

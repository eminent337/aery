 ...
 * `BlobStore` keep writing to `~/.aery/agent/...`. Reach for object storage
 * if you need those off-host too.
 */

import { createAgentSession, SessionManager, SqlSessionStorage } from "@aryee337/aery";
import { SQL } from "bun";
...
const storage = await SqlSessionStorage.create({
	client,
	table: "aery_session_files", // optional, this is the default

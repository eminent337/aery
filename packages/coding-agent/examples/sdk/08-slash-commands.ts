 ...
 */
import { createAgentSession, discoverPromptTemplates, type PromptTemplate, SessionManager } from "@aryee337/aery";

// Discover prompt templates from cwd/.aery/prompts/ and ~/.aery/agent/prompts/

...
- Changed extension loading to use upstream `jiti` 2.7 instead of the `@mariozechner/jiti` fork ([#4244](https://github.com/eminent337/aery/pull/4244) by [@pi0](https://github.com/pi0)).

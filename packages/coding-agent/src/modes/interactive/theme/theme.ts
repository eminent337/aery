...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@aryee/aery-tui";
...
const THEME_KEY = Symbol.for("@aryee/aery:theme");
...
export function getSettingsListTheme(): import("@aryee/aery-tui").SettingsListTheme {
	return {

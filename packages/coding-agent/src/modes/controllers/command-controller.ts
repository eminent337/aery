...
import { CompactionCancelledError, type CompactionOutcome } from "@aryee337/aery-core/compaction";
import { Loader, Markdown, padding, Spacer, Text, visibleWidth } from "@aryee337/aery-tui";
import { formatDuration, Snowflake } from "@aryee337/aery-utils";
import { $ } from "bun";
...
export class CommandController {
	...
	async handleMoveCommand(targetPath?: string): Promise<void> {
		...
		// No argument in TUI mode: open the interactive path autocomplete overlay.
		if (!input) {

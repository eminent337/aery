 ...
 *
 * Rendered as a centered overlay via `showHookCustom(..., { overlay: true })`.
 ...
 *
 * Ported from upstream with Aery's sovereign TUI primitives and branding.
 */
import * as fs from "node:fs";
import * as os from "node:os";
import * as path from "node:path";
import { type Component, CURSOR_MARKER, type Focusable, Key, matchesKey } from "@aryee337/aery-tui";

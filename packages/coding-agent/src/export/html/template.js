    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="aery-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="aery-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'aery-share:v1:sidebar-width';

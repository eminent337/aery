import { logger, toError } from "@aryee337/aery-utils";
...
export interface RedisSessionStorageOptions {
	...
	/**
	 * Key prefix applied to every Redis key this storage owns. Default `aery:sessions:`.
...
const DEFAULT_PREFIX = "aery:sessions:";

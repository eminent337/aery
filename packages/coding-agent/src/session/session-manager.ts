...
import { getTerminalId } from "@aryee337/aery-tui";
import {
	getBlobsDir,
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	/** True if generated by an extension, undefined/false if aery-generated (backward compatible) */
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if aery-generated */
	fromExtension?: boolean;
}
...
export class SessionManager {
	...
	#onSessionIndexed?: (sessionId: string) => void;

	setOnSessionIndexed(fn: (sessionId: string) => void): void {
		this.#onSessionIndexed = fn;
	}
	...
	// Called after save() succeeds so we can notify indexing tools
	#notifyIndexed(): void {
		this.#onSessionIndexed?.(this.#sessionId);
	}
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.aery/agent/sessions/<encoded-cwd>/).
	 */

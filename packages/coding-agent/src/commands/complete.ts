/**
 * `aery __complete <kind> [-- <prefix>]` — dynamic completion candidates.
 *
 ...
 */
import { type GeneratedProvider, getBundledModels, getBundledProviders } from "@aryee337/aery-ai/models";
import { Command } from "@aryee337/aery-utils/cli";

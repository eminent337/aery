/**
 * `aery completions <bash|zsh|fish>` — print a shell completion script.
 *
 ...
 */
import { APP_NAME, VERSION } from "@aryee337/aery-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@aryee337/aery-utils/cli";

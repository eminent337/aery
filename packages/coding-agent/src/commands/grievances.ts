...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `aery grievances` invocation working unchanged
	...
	static examples = [
		"aery grievances",
		"aery grievances list --tool find",
		"aery grievances clean --id 209",
		"aery grievances clean --tool find",
		"aery grievances clean --all",
		"aery grievances push",
	];

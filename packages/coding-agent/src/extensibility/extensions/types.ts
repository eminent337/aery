...
import type { OAuthCredentials, OAuthLoginCallbacks } from "@aryee337/aery-ai/utils/oauth/types";
import type { AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel } from "@aryee337/aery-core";
import type { CompactionResult } from "@aryee337/aery-core/compaction";
import type { AutocompleteItem, Component, EditorTheme, KeyId, TUI } from "@aryee337/aery-tui";
import type { logger as PiLogger } from "@aryee337/aery-utils";
...
export interface ExtensionContext {
	...
	/** Task recursion depth. Greater than 0 for subagent workers. */
	taskDepth?: number;
...
export interface ExtensionAPI {
	 ...
	 * aery.registerProvider("google-vertex-claude", {

...
import type { CredentialDisabledEvent, ImageContent, Model, ProviderResponseMetadata } from "@aryee337/aery-ai";
...
export class ExtensionRunner {
	...
	initialize(
		...
		// spread adds the `type` discriminator — `event` is the aery-ai shape (no `type`).

 ...
 *
 * Dependencies (the zod-backed typebox shim and aery-coding-agent) are injected via the
...
export class CustomToolLoader {
	...
	constructor(
		aery: typeof import("@aryee337/aery"),
		cwd: string,
...
export async function loadCustomTools(
	...
	const loader = new CustomToolLoader(await import("@aryee337/aery"), cwd, builtInToolNames, pushPendingAction);
 ...
 * 2. Installed plugins (~/.aery/plugins/node_modules/*)
...
export async function discoverAndLoadCustomTools(
	...
	// 2. Plugin tools: ~/.aery/plugins/node_modules/*/

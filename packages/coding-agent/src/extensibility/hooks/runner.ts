...
export class HookRunner {
	...
	initialize(options: {
		...
		// Set per-hook handlers for aery.sendMessage() and aery.appendEntry()
	 ...
	 *
	 * Note: Messages are already deep-copied by the caller (aery-ai preprocessor).
	 */
	...
	async emitBeforeAgentStart(
		prompt: string,
		images?: import("@aryee337/aery-ai").ImageContent[],

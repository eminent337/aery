...
/**
 * Send message handler type for aery.sendMessage().
 */
...
/**
 * Append entry handler type for aery.appendEntry().
 */
...
export interface LoadedHook {
	...
	/** Set the send message handler for this hook's aery.sendMessage() */
	setSendMessageHandler: (handler: SendMessageHandler) => void;
	/** Set the append entry handler for this hook's aery.appendEntry() */
...
async function createHookAPI(
	...
	const api = {
		...
		typebox,
		zod,
		aery: await import("@aryee337/aery"),
	} as HookAPI;
 ...
 * 1. AERY native configs (.aery/.aery hooks/)
 * 2. Installed plugins

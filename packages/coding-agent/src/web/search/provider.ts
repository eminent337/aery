...
const PROVIDER_META: Record<SearchProviderId, ProviderMeta> = {
	...
	ddg: {
		id: "ddg",
		label: "DuckDuckGo",
		load: async () => new (await import("./providers/ddg")).DDGProvider(),
	},
};
...
/** 4-tier cascade order: tavily → exa → parallel → ddg */
export const SEARCH_PROVIDER_ORDER: SearchProviderId[] = ["tavily", "exa", "parallel", "ddg"];

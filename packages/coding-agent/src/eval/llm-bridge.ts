...
import { type Api, Effort, getSupportedEfforts, type Model, type Tool } from "@aryee337/aery-ai";
import { instrumentedCompleteSimple, resolveTelemetry } from "@aryee337/aery-core";
 ...
 * active model and falls back to the `aery/default` role; `smol`/`slow` resolve

 ...
 * primitive in `@aryee337/aery-engine`, which infers the language from the file
...
import { blockRangeAt } from "@aryee337/aery-engine";
import type { BlockResolver } from "@aryee337/hashline";

...
import { glob, type SummaryResult, summarizeCode } from "@aryee337/aery-engine";
import type { Component } from "@aryee337/aery-tui";
import { Text } from "@aryee337/aery-tui";
import { getRemoteDir, logger, prompt, readImageMetadata, untilAborted } from "@aryee337/aery-utils";
import { formatHashlineHeader, formatNumberedLine, formatNumberedLines } from "@aryee337/hashline";
...
export class ReadTool implements AgentTool<typeof readSchema, ReadToolDetails> {
	...
	async execute(
		...
		// Handle internal URLs (agent://, artifact://, memory://, skill://, rule://, local://, mcp://, aery://, issue://, pr://).

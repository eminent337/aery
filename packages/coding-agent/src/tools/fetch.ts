...
import { htmlToMarkdown } from "@aryee337/aery-engine";
import { type Component, Text } from "@aryee337/aery-tui";
import { $which, ptree, truncate } from "@aryee337/aery-utils";
...
async function renderUrl(
	...
	// Handle internal protocol URLs (e.g., aery-internal://) - return empty
	if (url.startsWith("aery-internal://")) {
		return {
			url,
			finalUrl: url,

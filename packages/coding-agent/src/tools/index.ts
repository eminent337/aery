import type { ToolChoice } from "@aryee337/aery-ai";
...
/** Tool type (AgentTool from aery-ai) */
...
export interface ToolSession {
	...
	/** Whether the active model can see images (vision-capable). Undefined when unknown. */

 ...
 */
import { type Effort, THINKING_EFFORTS } from "@aryee337/aery-ai";
import { APP_NAME, CONFIG_DIR_NAME, logger } from "@aryee337/aery-utils";
import chalk from "chalk";
import { parseEffort } from "../thinking";
import { BUILTIN_TOOLS } from "../tools";

export type Mode = "text" | "json" | "rpc" | "acp" | "rpc-ui" | "fas" | "ferment";
...
${chalk.bold("Useful Commands:")}
  aery agents unpack           - Export bundled subagents to ~/.aery/agent/agents (default)
  aery agents unpack --project - Export bundled subagents to ./.aery/agents`;
}

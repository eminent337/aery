 ...
 *
 * Handles `aery setup` for onboarding and `aery setup <component>` for optional dependencies.
 */
import * as path from "node:path";
import { $which, APP_NAME, getPythonEnvDir } from "@aryee337/aery-utils";
import { $ } from "bun";
...
// package dependencies beyond a working interpreter. `aery setup python --check`

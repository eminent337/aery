...
import { registerOAuthProvider, unregisterOAuthProviders } from "@aryee337/aery-ai/utils/oauth";
import type { OAuthCredentials, OAuthLoginCallbacks } from "@aryee337/aery-ai/utils/oauth/types";
import { isRecord, logger } from "@aryee337/aery-utils";
...
export type ModelRole = "default" | "smol" | "slow" | "vision" | "plan" | "designer" | "commit" | "task" | "advisor";
...
export const MODEL_ROLES: Record<ModelRole, ModelRoleInfo> = {
	...
	advisor: { tag: "ADVISOR", name: "Advisor", color: "success" },
};
...
export class ModelRegistry {
	 ...
	 *
	 * Mirrors the upstream API surface so that

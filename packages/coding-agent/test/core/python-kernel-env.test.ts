...
import { enumeratePythonRuntimes, filterEnv, resolvePythonRuntime } from "@aryee337/aery/eval/py/runtime";
...
describe("enumeratePythonRuntimes", () => {
	...
	const managedDir = path.join(path.sep, "fake", ".aery", "python-env");

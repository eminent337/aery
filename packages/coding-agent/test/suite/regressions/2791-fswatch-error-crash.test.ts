...
/**
 * Regression test for https://github.com/eminent337/aery/issues/2791
 *
...
process.env.AERY_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync("npx", ["tsx", scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, AERY_CODING_AGENT_DIR: agentDir },

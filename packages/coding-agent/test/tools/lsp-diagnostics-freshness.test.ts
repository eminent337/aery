...
import { createLspWritethrough } from "@aryee337/aery/lsp";
import * as lspClient from "@aryee337/aery/lsp/client";
import * as lspConfig from "@aryee337/aery/lsp/config";
import type { Diagnostic, LspClient, ServerConfig } from "@aryee337/aery/lsp/types";
import { fileToUri } from "@aryee337/aery/lsp/utils";
import { type ptree, TempDir } from "@aryee337/aery-utils";
...
describe("LSP diagnostics freshness", () => {
	...
	beforeEach(() => {
		tempDir = TempDir.createSync("@aery-lsp-freshness-");
	});

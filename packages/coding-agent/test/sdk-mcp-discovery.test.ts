...
import type { CustomTool } from "@aryee337/aery/extensibility/custom-tools/types";
import { createAgentSession } from "@aryee337/aery/sdk";
import { SessionManager } from "@aryee337/aery/session/session-manager";
import { AuthStorage, Effort, getBundledModel, type Model } from "@aryee337/aery-ai";
...
describe("createAgentSession MCP discovery prompt gating", () => {
	...
	beforeEach(async () => {
		tempDir = path.join(os.tmpdir(), `aery-sdk-mcp-discovery-${Snowflake.next()}`);

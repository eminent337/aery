...
function makeTempDir(prefix = "aery-autoresearch-tools"): string {
...
describe("init_experiment", () => {
	...
	beforeEach(() => {
		dbOverride = makeTempDir("aery-autoresearch-init-db");
		process.env.AERY_AUTORESEARCH_DB_DIR = dbOverride;
	});

	afterEach(() => {
		delete process.env.AERY_AUTORESEARCH_DB_DIR;
...
describe("run_experiment", () => {
	...
	beforeEach(() => {
		dbOverride = makeTempDir("aery-autoresearch-run-db");
		process.env.AERY_AUTORESEARCH_DB_DIR = dbOverride;
	});
...
describe("log_experiment", () => {
	...
	beforeEach(() => {
		dbOverride = makeTempDir("aery-autoresearch-log-db");
		process.env.AERY_AUTORESEARCH_DB_DIR = dbOverride;
	});
...
describe("update_notes", () => {
	...
	beforeEach(() => {
		dbOverride = makeTempDir("aery-autoresearch-notes-db");
		process.env.AERY_AUTORESEARCH_DB_DIR = dbOverride;
	});

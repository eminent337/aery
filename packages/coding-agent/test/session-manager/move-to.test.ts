...
import { loadEntriesFromFile, type SessionHeader, SessionManager } from "@aryee337/aery/session/session-manager";
import { stripOuterDoubleQuotes } from "@aryee337/aery/tools/path-utils";
import { getConfigRootDir, setAgentDir } from "@aryee337/aery-utils";
...
describe("SessionManager.moveTo", () => {
	...
	beforeEach(async () => {
		testAgentDir = await fsp.mkdtemp(path.join(os.tmpdir(), "aery-move-test-"));

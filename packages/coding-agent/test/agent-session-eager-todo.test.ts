...
import { TodoWriteTool } from "@aryee337/aery/tools";
import { type AssistantMessage, getBundledModel, type TextContent, type ToolCall } from "@aryee337/aery-ai";
...
describe("AgentSession eager todo enforcement", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@aery-agent-session-eager-todo-");
		streamCallCount = 0;
		scriptedResponses = [];

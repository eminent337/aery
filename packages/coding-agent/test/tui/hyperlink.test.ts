...
import { resetSettingsForTest, Settings, settings } from "@aryee337/aery/config/settings";
import { fileHyperlink, isHyperlinkEnabled, tryResolveInternalUrlSync } from "@aryee337/aery/tui/hyperlink";
import * as terminalCaps from "@aryee337/aery-tui";
...
describe("tryResolveInternalUrlSync", () => {
	...
	it("returns undefined for unsupported internal URL schemes", () => {
		...
		expect(tryResolveInternalUrlSync("aery://docs.md")).toBeUndefined();
	});

...
import type { MarketplacePluginEntry } from "@aryee337/aery/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@aryee337/aery/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "aery-src-res-test-"));
	});

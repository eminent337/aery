...
import {
	...
	type SessionEvent,
} from "@aryee337/aery/extensibility/hooks";
import { theme } from "@aryee337/aery/modes/theme/theme";
...
describe.skipIf(!e2eApiKey("ANTHROPIC_API_KEY"))("Compaction hooks", () => {
	...
	beforeEach(() => {
		tempDir = path.join(os.tmpdir(), `aery-compaction-hooks-test-${Snowflake.next()}`);

...
/**
 * Regression for https://github.com/eminent337/aery/issues/1150
 *
 * In v15.1.3 `aery stats` crashed in the published Linux/macOS/Windows
 ...
 * the tab worker entry. Runtime coverage lives in `aery --smoke-test`,

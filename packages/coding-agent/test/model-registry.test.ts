...
import { kNoAuth, ModelRegistry } from "@aryee337/aery/config/model-registry";
...
import { Effort, type Model, type OpenAICompat, type ThinkingConfig, writeModelCache } from "@aryee337/aery-ai";
...
describe("ModelRegistry", () => {
	...
	beforeEach(async () => {
		...
		tempDir = path.join(os.tmpdir(), `aery-test-model-registry-${Snowflake.next()}`);

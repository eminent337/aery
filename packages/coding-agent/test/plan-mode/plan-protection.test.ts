...
import { createPlanReadMatcher } from "@aryee337/aery/plan-mode/plan-protection";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@aryee337/aery-ai";
import type { AgentToolCall } from "@aryee337/aery-core";
import type { SessionMessageEntry } from "@aryee337/aery-core/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@aryee337/aery-core/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@aryee337/aery-core/compaction/shake";
import type { ProtectedToolContext } from "@aryee337/aery-core/compaction/tool-protection";

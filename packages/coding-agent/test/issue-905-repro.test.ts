 ...
 *
 * `aery --list-models` did not include providers contributed by extensions
 * (via `aery.registerProvider(...)`), regardless of whether the extension was
...
import { AuthStorage } from "@aryee337/aery-ai";

...
import { ExtensionRunner, loadExtensions } from "@aryee337/aery/extensibility/extensions";
...
import type { AssistantMessage, ToolCall } from "@aryee337/aery-ai";
...
import * as compactionModule from "@aryee337/aery-core/compaction";
...
describe("AgentSession handoff", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@aery-handoff-");

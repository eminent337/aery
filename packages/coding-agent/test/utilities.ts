...
import { getModel, type OAuthCredentials, type OAuthProvider } from "@eminent337/aery-ai";
...
/**
 * Resolve API key for a provider from ~/.aery/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.aery/agent/auth.json
 */

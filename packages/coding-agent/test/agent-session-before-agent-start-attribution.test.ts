...
import type { ExtensionRunner } from "@aryee337/aery/extensibility/extensions";
...
import { getBundledModel, type Message } from "@aryee337/aery-ai";
import { inferCopilotInitiator } from "@aryee337/aery-ai/providers/github-copilot-headers";
import { createMockModel } from "@aryee337/aery-ai/providers/mock";
import { Agent, type AgentMessage } from "@aryee337/aery-core";
...
describe("AgentSession before_agent_start attribution fallback", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@aery-before-agent-start-attribution-");

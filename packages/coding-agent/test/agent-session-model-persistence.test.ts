...
import { type CreateAgentSessionResult, createAgentSession } from "@aryee337/aery/sdk";
...
import { type Api, Effort, getBundledModel, type Model } from "@aryee337/aery-ai";
...
describe("AgentSession model persistence", () => {
	...
	beforeEach(() => {
		tempDir = TempDir.createSync("@aery-model-persistence-");
	});

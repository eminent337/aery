...
import { SecretObfuscator } from "@aryee337/aery/secrets/obfuscator";
...
import type { AssistantMessage, TextContent } from "@aryee337/aery-ai";
...
async function createSessionWithObfuscator(obfuscator?: SecretObfuscator): Promise<SessionFixture> {
	const tempDir = TempDir.createSync("@aery-silent-abort-");

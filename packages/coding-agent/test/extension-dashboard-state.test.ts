...
import { applyDisabledExtensionsToState } from "@aryee337/aery/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@aryee337/aery/modes/components/extensions/types";
